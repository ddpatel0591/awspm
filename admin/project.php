...
<div class="content-wrapper">
  ...
  <div class="card">
    <div class="card-header">
      ...
      <a href="" id="add_taskbtn" data-toggle="modal" data-target="#AdduserModal"
        class="btn btn-primary float-right">Add Task</a>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      ...
      <script>
        $(document).ready(function () {
          ...
          $(document).on("click", "#add_taskbtn", function () {
            $("#project_id").val("0");
            $("#project").val("");
          });
          $(document).on("click", ".btn-info", function () {
            var task_id = $(this).data("eid");
            $("#project_id").val(task_id);
            $("#project").val($(this).parents("tr").find(".projectname").text());
          });
        });
      </script>
    </div>
